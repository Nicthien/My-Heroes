...
export const CREATURE_BANK_DEFINITIONS: Record<CreatureBankType, CreatureBankDefinition> = {
  ancient_altar: bank("ancient_altar", "Ancient Altar", "Autel elementaire defendu par des gardiens magiques.", [TerrainType.GRASS, TerrainType.MOUNTAIN, TerrainType.LAVA], 0.35, [
  ...
  beholders_sanctuary: bank("beholders_sanctuary", "Beholders Sanctuary", "Sanctuaire souterrain aux regards mortels.", [TerrainType.DIRT, TerrainType.MOUNTAIN, TerrainType.SWAMP], 0.85, [
  ...
  black_tower: bank("black_tower", "Black Tower", "Tour noire gardee par des dragons.", [TerrainType.MOUNTAIN, TerrainType.LAVA, TerrainType.DIRT], 0.25, [
  ...
  churchyard: bank("churchyard", "Churchyard", "Cimetiere maudit rempli de morts-vivants.", [TerrainType.DIRT, TerrainType.SWAMP, TerrainType.FOREST], 1.0, [
  ...
  crypt: bank("crypt", "Crypt", "Tombe ancienne aux tresors ensevelis.", [TerrainType.DIRT, TerrainType.SWAMP, TerrainType.SNOW], 1.25, [
  ...
  cyclops_stockpile: bank("cyclops_stockpile", "Cyclops Stockpile", "Reserve fortifiee remplie de projectiles et minerais.", [TerrainType.MOUNTAIN, TerrainType.DIRT, TerrainType.SAND], 0.55, [
  ...
  derelict_ship: bank("derelict_ship", "Derelict Ship", "Epave echouee gardee par un equipage hostile.", [TerrainType.SAND, TerrainType.WATER, TerrainType.SWAMP], 0.75, [
  ...
  dragon_fly_hive: bank("dragon_fly_hive", "Dragon Fly Hive", "Nid bourdonnant des marais.", [TerrainType.SWAMP, TerrainType.FOREST, TerrainType.GRASS], 1.05, [
  ...
  dragon_utopia: bank("dragon_utopia", "Dragon Utopia", "Tresor mythique protege par plusieurs dragons.", [TerrainType.MOUNTAIN, TerrainType.LAVA, TerrainType.SNOW], 0.18, [
  ...
  dwarven_treasury: bank("dwarven_treasury", "Dwarven Treasury", "Tresorerie naine blinde de coffres.", [TerrainType.MOUNTAIN, TerrainType.FOREST, TerrainType.SNOW], 1.0, [
  ...
  experimental_shop: bank("experimental_shop", "Experimental Shop", "Atelier bruyant rempli de prototypes.", [TerrainType.DIRT, TerrainType.SAND, TerrainType.MOUNTAIN], 0.7, [
  ...
  griffin_conservatory: bank("griffin_conservatory", "Griffin Conservatory", "Rocher-nid de griffons royaux.", [TerrainType.GRASS, TerrainType.MOUNTAIN, TerrainType.SNOW], 0.8, [
  ...
  imp_cache: bank("imp_cache", "Imp Cache", "Cache infernale pleine de soufre et d'or vole.", [TerrainType.LAVA, TerrainType.DIRT, TerrainType.SAND], 1.2, [
  ...
  ivory_tower: bank("ivory_tower", "Ivory Tower", "Tour blanche protegee par des mages.", [TerrainType.SNOW, TerrainType.GRASS, TerrainType.MOUNTAIN], 0.65, [
  ...
  mansion: bank("mansion", "Mansion", "Manoir occulte de vampires.", [TerrainType.DIRT, TerrainType.SWAMP, TerrainType.FOREST], 0.75, [
  ...
  medusa_stores: bank("medusa_stores", "Medusa Stores", "Depot pierreux de meduses.", [TerrainType.SAND, TerrainType.DIRT, TerrainType.MOUNTAIN], 0.9, [
  ...
  naga_bank: bank("naga_bank", "Naga Bank", "Banque gardee par des nagas.", [TerrainType.SNOW, TerrainType.GRASS, TerrainType.MOUNTAIN], 0.45, [
  ...
  pirate_cavern: bank("pirate_cavern", "Pirate Cavern", "Caverne cotiere remplie de butin.", [TerrainType.SAND, TerrainType.WATER, TerrainType.SWAMP], 0.8, [
  ...
  red_tower: bank("red_tower", "Red Tower", "Tour ecarlate protegee par des dragons rouges.", [TerrainType.MOUNTAIN, TerrainType.LAVA, TerrainType.DIRT], 0.28, [
  ...
  ruins: bank("ruins", "Ruins", "Ruines gardees par des soldats oublies.", [TerrainType.DIRT, TerrainType.GRASS, TerrainType.FOREST], 1.05, [
  ...
  shipwreck: bank("shipwreck", "Shipwreck", "Navire brise charge de tresors.", [TerrainType.SAND, TerrainType.WATER, TerrainType.SWAMP], 0.65, [
  ...
  spit: bank("spit", "Spit", "Banc de sable protege par des creatures marines.", [TerrainType.SAND, TerrainType.WATER], 0.75, [
  ...
  temple_of_the_sea: bank("temple_of_the_sea", "Temple of the Sea", "Temple marin consacre aux serpents des abysses.", [TerrainType.WATER, TerrainType.SAND, TerrainType.SWAMP], 0.35, [
  ...
  wolf_raider_picket: bank("wolf_raider_picket", "Wolf Raider Picket", "Poste de pillards rapides.", [TerrainType.DIRT, TerrainType.GRASS, TerrainType.SAND], 1.15, [
