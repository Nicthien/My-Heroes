...
export const SPELLS: SpellDefinition[] = [
  ...
  { id: "titans_lightning_bolt", label: "Éclair de Titan", school: "air", context: "combat", level: 5, cost: { standard: 0, expert: 0 }, kind: "damage", implemented: false, effect: "Necessite l'artefact Tonnerre des Titans.", damage: damage([600, 600, 600], 0) },
  ...
  { id: "fire_wall", label: "Mur de feu", school: "fire", context: "combat", level: 2, cost: { standard: 8, expert: 6 }, kind: "damage", implemented: false, effect: "Crée un mur infligeant des dégâts au passage.", damage: damage([10, 20, 50], 15) },
  ...
  { id: "inferno", label: "Inferno", school: "fire", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "damage", implemented: true, effect: "Inflige des dégâts de feu dans une grande zone.", damage: damage([20, 40, 80], 10) },
  ...
  { id: "disrupting_ray", label: "Rayon affaiblissant", school: "air", context: "combat", level: 2, cost: { standard: 10, expert: 8 }, kind: "debuff", implemented: false, effect: "Réduit la defense." },
  ...
  { id: "precision", label: "Precision", school: "air", context: "combat", level: 2, cost: { standard: 8, expert: 6 }, kind: "buff", implemented: false, effect: "Augmente l'attaque à distance." },
  { id: "protection_from_air", label: "Protection contre l'air", school: "air", context: "combat", level: 2, cost: { standard: 7, expert: 5 }, kind: "buff", implemented: false, effect: "Réduit les dégâts des sorts d'air." },
  { id: "air_shield", label: "Bouclier d'air", school: "air", context: "combat", level: 3, cost: { standard: 12, expert: 9 }, kind: "buff", implemented: false, effect: "Réduit les dégâts à distance." },
  ...
  { id: "summon_air_elemental", label: "Invocation d'élémentaires d'air", school: "air", context: "combat", level: 5, cost: { standard: 25, expert: 20 }, kind: "utility", implemented: false, effect: "Invoque des élémentaires d'air." },

  { id: "shield", label: "Bouclier", school: "earth", context: "combat", level: 1, cost: { standard: 5, expert: 4 }, kind: "buff", implemented: false, effect: "Réduit les dégâts au corps-à-corps." },
  { id: "slow", label: "Lenteur", school: "earth", context: "combat", level: 1, cost: { standard: 6, expert: 5 }, kind: "debuff", implemented: false, effect: "Réduit la vitesse." },
  ...
  { id: "force_field", label: "Champ de force", school: "earth", context: "combat", level: 3, cost: { standard: 12, expert: 9 }, kind: "utility", implemented: false, effect: "Crée une barriere." },
  { id: "protection_from_earth", label: "Protection contre la terre", school: "earth", context: "combat", level: 3, cost: { standard: 12, expert: 9 }, kind: "buff", implemented: false, effect: "Réduit les dégâts des sorts de terre." },
  { id: "resurrection", label: "Résurrection", school: "earth", context: "combat", level: 4, cost: { standard: 20, expert: 16 }, kind: "utility", implemented: false, effect: "Ranime des créatures vivantes." },
  { id: "sorrow", label: "Tristesse", school: "earth", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "debuff", implemented: false, effect: "Réduit le moral." },
  { id: "summon_earth_elemental", label: "Invocation d'élémentaires de terre", school: "earth", context: "combat", level: 5, cost: { standard: 25, expert: 20 }, kind: "utility", implemented: false, effect: "Invoque des élémentaires de terre." },

  { id: "bloodlust", label: "Soif de sang", school: "fire", context: "combat", level: 1, cost: { standard: 5, expert: 4 }, kind: "buff", implemented: false, effect: "Augmente l'attaque au corps-à-corps." },
  { id: "curse", label: "Malédiction", school: "fire", context: "combat", level: 1, cost: { standard: 6, expert: 5 }, kind: "debuff", implemented: false, effect: "Force les dégâts minimum." },
  { id: "protection_from_fire", label: "Protection contre le feu", school: "fire", context: "combat", level: 1, cost: { standard: 5, expert: 4 }, kind: "buff", implemented: false, effect: "Réduit les dégâts des sorts de feu." },
  ...
  { id: "misfortune", label: "Infortune", school: "fire", context: "combat", level: 3, cost: { standard: 12, expert: 9 }, kind: "debuff", implemented: false, effect: "Réduit la chance." },
  ...
  { id: "fire_shield", label: "Bouclier de feu", school: "fire", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "buff", implemented: false, effect: "Renvoie une part des dégâts de mêlée." },
  { id: "frenzy", label: "Frénésie", school: "fire", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "buff", implemented: false, effect: "Convertit la defense en attaque." },
  { id: "slayer", label: "Tueur", school: "fire", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "buff", implemented: false, effect: "Augmente l'attaque contre les créatures puissantes." },
  ...
  { id: "summon_fire_elemental", label: "Invocation d'élémentaires de feu", school: "fire", context: "combat", level: 5, cost: { standard: 25, expert: 20 }, kind: "utility", implemented: false, effect: "Invoque des élémentaires de feu." },

  { id: "bless", label: "Bénédiction", school: "water", context: "combat", level: 1, cost: { standard: 5, expert: 4 }, kind: "buff", implemented: false, effect: "Force les dégâts maximum." },
  ...
  { id: "protection_from_water", label: "Protection contre l'eau", school: "water", context: "combat", level: 1, cost: { standard: 5, expert: 4 }, kind: "buff", implemented: false, effect: "Réduit les dégâts des sorts d'eau." },
  ...
  { id: "weakness", label: "Faiblesse", school: "water", context: "combat", level: 2, cost: { standard: 8, expert: 6 }, kind: "debuff", implemented: false, effect: "Réduit l'attaque." },
  ...
  { id: "clone", label: "Clone", school: "water", context: "combat", level: 4, cost: { standard: 24, expert: 20 }, kind: "utility", implemented: false, effect: "Crée une copie temporaire d'une troupe." },
  { id: "prayer", label: "Prière", school: "water", context: "combat", level: 4, cost: { standard: 16, expert: 12 }, kind: "buff", implemented: false, effect: "Augmente attaque, defense et vitesse." },
  { id: "summon_water_elemental", label: "Invocation d'élémentaires d'eau", school: "water", context: "combat", level: 5, cost: { standard: 25, expert: 20 }, kind: "utility", implemented: false, effect: "Invoque des élémentaires d'eau." },
  ...
  { id: "disguise", label: "Déguisement", school: "air", context: "adventure", level: 2, cost: { standard: 4, expert: 2 }, kind: "utility", implemented: false, effect: "Masque l'armée du héros aux adversaires." },
