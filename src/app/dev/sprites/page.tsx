...
const PUBLIC_SVGS: { path: string; label: string; group: string }[] = [
  ...
  { path: "/assets/sprites/map/town-castle.svg", label: "Ville château", group: "Factions" },
  { path: "/assets/sprites/map/hero-rampart.svg", label: "Héros rempart", group: "Factions" },
  { path: "/assets/sprites/map/town-rampart.svg", label: "Ville rempart", group: "Factions" },
  { path: "/assets/sprites/map/hero-tower.svg", label: "Héros tour", group: "Factions" },
  { path: "/assets/sprites/map/town-tower.svg", label: "Ville tour", group: "Factions" },
  { path: "/assets/sprites/map/hero-inferno.svg", label: "Héros Hadès", group: "Factions" },
  { path: "/assets/sprites/map/town-inferno.svg", label: "Ville Hadès", group: "Factions" },
  { path: "/assets/sprites/map/hero-necropolis.svg", label: "Héros nécropole", group: "Factions" },
  { path: "/assets/sprites/map/town-necropolis.svg", label: "Ville nécropole", group: "Factions" },
  { path: "/assets/sprites/map/hero-dungeon.svg", label: "Héros donjon", group: "Factions" },
  { path: "/assets/sprites/map/town-dungeon.svg", label: "Ville donjon", group: "Factions" },
  { path: "/assets/sprites/map/hero-stronghold.svg", label: "Héros bastion", group: "Factions" },
  { path: "/assets/sprites/map/town-stronghold.svg", label: "Ville bastion", group: "Factions" },
  { path: "/assets/sprites/map/hero-fortress.svg", label: "Héros forteresse", group: "Factions" },
  { path: "/assets/sprites/map/town-fortress.svg", label: "Ville forteresse", group: "Factions" },
