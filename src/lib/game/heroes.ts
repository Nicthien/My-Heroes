...
export const CLASS_STARTING_STATS: Record<HeroClass, HeroStats> = {
  [HeroClass.KNIGHT]: { attack: 2, defense: 2, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.CLERIC]: { attack: 1, defense: 0, spellPower: 2, knowledge: 2, morale: 0 },
  [HeroClass.RANGER]: { attack: 1, defense: 3, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.DRUID]: { attack: 0, defense: 2, spellPower: 1, knowledge: 2, morale: 0 },
  [HeroClass.ALCHEMIST]: { attack: 1, defense: 1, spellPower: 2, knowledge: 2, morale: 0 },
  [HeroClass.WIZARD]: { attack: 0, defense: 0, spellPower: 2, knowledge: 3, morale: 0 },
  [HeroClass.DEMONIAC]: { attack: 2, defense: 2, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.HERETIC]: { attack: 1, defense: 1, spellPower: 2, knowledge: 2, morale: 0 },
  [HeroClass.DEATH_KNIGHT]: { attack: 1, defense: 2, spellPower: 2, knowledge: 1, morale: 0 },
  [HeroClass.NECROMANCER]: { attack: 1, defense: 0, spellPower: 2, knowledge: 2, morale: 0 },
  [HeroClass.OVERLORD]: { attack: 2, defense: 2, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.WARLOCK]: { attack: 0, defense: 0, spellPower: 3, knowledge: 2, morale: 0 },
  [HeroClass.BARBARIAN]: { attack: 4, defense: 0, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.BATTLE_MAGE]: { attack: 2, defense: 1, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.BEASTMASTER]: { attack: 1, defense: 2, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.WITCH]: { attack: 0, defense: 1, spellPower: 2, knowledge: 2, morale: 0 },
  [HeroClass.PLANESWALKER]: { attack: 2, defense: 2, spellPower: 1, knowledge: 1, morale: 0 },
  [HeroClass.ELEMENTALIST]: { attack: 0, defense: 0, spellPower: 3, knowledge: 3, morale: 0 },
};
