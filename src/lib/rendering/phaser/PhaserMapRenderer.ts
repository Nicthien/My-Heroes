...
import { drawRampartCrenels, drawRampartFace, drawRampartTopStones } from "@/lib/rendering/phaser/rampartDrawing";
import {
...
class PhaserMapScene extends Phaser.Scene {
  ...
  private drawBrickRampart(isoX: number, isoY: number, tile?: MapTile) {
    ...
    drawRampartFace(graphics, topD, topC, baseD, baseC, 0x5f584c);
    drawRampartFace(graphics, topC, topB, baseC, baseB, 0x4b443b);
    drawRampartFace(graphics, topA, topD, baseA, baseD, 0x756d5d);
    ...
    drawRampartTopStones(graphics, topA, topB, topC, topD);
    drawRampartCrenels(graphics, topA, topB, topC, topD, axis.crenelCount);
