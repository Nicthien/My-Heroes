...
const PUBLIC_SVGS: { path: string; label: string; group: string }[] = [
  ...
  { path: "/assets/sprites/map/adventure-observatory.svg", label: "Observatoire", group: "Carte - aventures" },
  { path: "/assets/sprites/map/adventure-campfire.svg", label: "Feu de camp", group: "Carte - aventures" },
  { path: "/assets/sprites/map/adventure-lighthouse.svg", label: "Phare", group: "Carte - aventures" },
  { path: "/assets/sprites/map/adventure-stargate.svg", label: "Stargate", group: "Carte - aventures" },
  { path: "/assets/sprites/map/wall-brick.svg", label: "Mur de pierre", group: "Carte - obstacles" },
  { path: "/assets/sprites/map/wall-vegetal.svg", label: "Mur végétal", group: "Carte - obstacles" },
  ...
  { path: "/assets/sprites/map/grove-pine.svg", label: "Bosquet de pins", group: "Carte - obstacles" },
  { path: "/assets/sprites/map/grove-oak.svg", label: "Bosquet de chenes", group: "Carte - obstacles" },
  { path: "/assets/sprites/map/grove-dead.svg", label: "Bosquet mort", group: "Carte - obstacles" },
  { path: "/assets/sprites/map/boulder-cluster.svg", label: "Amas de rochers", group: "Carte - obstacles" },
