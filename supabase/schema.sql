...
-- Service-role-only lifecycle events used for anonymous-account aggregates.
create table public.anonymous_account_events (
...
create index anonymous_account_events_occurred_at_idx on public.anonymous_account_events (occurred_at);
create index anonymous_account_events_type_occurred_at_idx on public.anonymous_account_events (event_type, occurred_at);
